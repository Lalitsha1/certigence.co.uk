          ...
          <Col lg={10} className="mx-auto">
            <div className="commitment-statement">
              ...
              <div className="statement-content">
                <p>
                  Certigence is fully committed to maintaining impartiality in all its certification activities. 
        ...
        <Row className="mt-5">
          <Col>
            <div className="policy-contact">
              <h4>Questions About Our Impartiality Policy?</h4>
              <p>Contact our Impartiality Committee at <a href="mailto:impartiality@certigence.co.uk">impartiality@certigence.co.uk</a></p>
              <button className="cta-btn">
                Download Full Policy Document <FaArrowRight />
              </button>
            </div>
          </Col>
        </Row>
